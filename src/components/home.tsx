...
export const HomeSection = () => {
  return (
    <section id="home" className="text-center flex h-screen">
      <div className="m-auto">
        ...
        <div className="grid grid-rows-1 text-center xl:grid-cols-2 w-max mx-auto gap-5 mb-10 my-5 font-ubuntu_sans">
