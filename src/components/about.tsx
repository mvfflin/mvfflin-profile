export const AboutSection = () => {
  return (
    <section id="about" className="text-center pb-64">
      ...
      <h1 className="text-xl">
        ...
        . Some of my projects are for fun, but i want to focus on to be a better
        programmer soon. You can see my stacks and my projects below. (i kinda
        have my own way in programming ngl)
      </h1>
    </section>
  );
};
