          ...
          <ol className="items-center sm:flex mt-10">
            <li className="relative mb-6 sm:mb-0">
              ...
              <div className="mt-3 sm:pe-8 ">
                <h3 className="text-lg lg:text-2xl font-bold text-black dark:text-white">
                  Hanji Community
                </h3>
                <h4 className="text-md lg:text-lg my-2 italic text-zinc-800 dark:text-gray-300">
                  as Minecraft Server Developer
                </h4>
                <time className="block mb-2 text-sm lg:text-lg font-normal leading-none  text-gray-500">
                  2020 - 2021
                </time>
            ...
            <li className="relative mb-6 sm:mb-0">
              ...
              <div className="mt-3 sm:pe-8">
                <h3 className="text-lg lg:text-2xl font-semibold text-black dark:text-white">
                  NexterCraft
                </h3>
                <h4 className="text-md lg:text-lg my-2 italic text-zinc-800 dark:text-gray-300">
                  as Minecraft Server Developer
